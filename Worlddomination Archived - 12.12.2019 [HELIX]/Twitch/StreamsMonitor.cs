...
namespace Worlddomination.Twitch
{
    public class StreamsMonitor
    {
        ...
        private bool is_monitor_initialized = true;
        ...
        private Stream[] OLDstreams_array;
        ...
        public  void PopulateStreamsData()
        {
            ...
            var request = Program.API.Helix.Streams.GetStreamsAsync(first: limit_of_streams, gameIds: ids).Result;
                ...
                {            
                    ...
                    {// Broadcast to discord
                        ...
                        try
                            ...
                            if (ids[0].Equals("491757")) game_name = "Overload";
